...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        GameObject closestAlarm = 
        if(playerController.CheckClosestAlarm() != null)
        {
            playerController.ShowAlarmText(true);

            if(alarmAction.IsPressed())
            {
                playerController.DeactivateAlarm();
            }
        }
